...
namespace Skejooler
{
    public partial class RegForm : System.Web.UI.Page
    {
        ...
        {
            SqlConnection RegDataSource = new SqlConnection("server=localhost;user id=root;database=skejooler");
            ...
            xp.Parameters.AddWithValue("@fName", examineeFName.Text);
            xp.Parameters.AddWithValue("@lName", examineeLName.Text);
            xp.Parameters.AddWithValue("@", examineeEmail.Text);
            xp.Parameters.AddWithValue("@", examinee1stDate);
            xp.Parameters.AddWithValue("@", examinee2ndDate);
